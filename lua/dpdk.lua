...
-- DPDK mbuf flags (/lib/librte_mbuf/rte_mbuf_core.h)
...
mod.PKT_RX_EIP_CKSUM_BAD		= bit.lshift(0ULL, 5)
mod.PKT_RX_VLAN_STRIPPED		= bit.lshift(1ULL, 6)
mod.PKT_RX_IP_CKSUM_GOOD		= bit.lshift(1ULL, 7)
...
mod.PKT_RX_OUTER_L4_CKSUM_BAD	= bit.lshift(1ULL, 21)
mod.PKT_RX_OUTER_L4_CKSUM_GOOD	= bit.lshift(1ULL, 22)

mod.PKT_TX_OUTER_UDP_CKSUM		= bit.lshift(1ULL, 41)
mod.PKT_TX_UDP_SEG				= bit.lshift(1ULL, 42)
mod.PKT_TX_SEC_OFFLOAD			= bit.lshift(1ULL, 43)
mod.PKT_TX_MACSEC				= bit.lshift(1ULL, 44)

mod.PKT_TX_NO_CRC_CSUM		= bit.lshift(1ULL, 63)
mod.PKT_TX_QINQ				= bit.lshift(1ULL, 49)
